...
import { HealthRecordsManager } from "@/components/health-records/health-records-manager"
...
export default function HealthRecordsPage() {
  ...
  useEffect(() => {
    if (isReady) {
      actions.navigate("/health-records")
    }
  }, [actions, isReady])
    ...
    return (
      <div className="min-h-screen wellness-gradient flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <p className="text-gray-600 mb-8">Please set up your profile to manage health records</p>
          <Link href="/setup">
